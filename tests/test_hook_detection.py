...
def test_list_remote_wgacl_chains_reports_ssh_failure(monkeypatch):
    monkeypatch.setattr(app_module, "ssh_run", lambda script, timeout=15: (False, "Timeout"))
