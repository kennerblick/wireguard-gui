"""Verwaltete Netze pro Client bearbeiten (Berechtigungen-Seite und
Dashboard-Dialog): LANs hinter einem Peer (typischerweise MikroTik)
hinterlegen/aendern."""
...
from .permissions import _redirect_next
